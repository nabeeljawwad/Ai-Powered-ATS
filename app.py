...
def get_chatbot_response(pdf_text, job_desc, question):
    prompt = f"""
    You are a professional AI assistant specializing in resume reviews and job matching. 
    Your role is to provide clear, accurate, and visually appealing answers that are easy to read and understand. 
    Please structure your answers in a friendly and concise manner, 
    highlighting key insights with bullet points or numbered lists when appropriate.
...
>>>>>>> 6a81bb79664f8e838403961d1f7e0c3c401032b4
